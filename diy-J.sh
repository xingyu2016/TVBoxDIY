...
cd $CURRENT_DIR/$DIR
#共存
sed -i 's/com.github.tvbox.osc/com.github.tvbox.osc.xy/g' $CURRENT_DIR/$DIR/app/build.gradle
#签名
...
#名称修改
sed -i 's/TVBox/星影视/g' $CURRENT_DIR/$DIR/app/src/main/res/values/strings.xml
#背景修改
